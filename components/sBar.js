...
function SBar() {
    return(
        ...
        <TextInput placeholderTextColor="#C7C7C7" placeholder="Search for recipes" style={{padding: 0,margin: 0,width: 313, height: 38, fontSize: 12, borderRadius: 54, paddingLeft: 24, paddingRight: 24, color: "#C7C7C7"}}>
