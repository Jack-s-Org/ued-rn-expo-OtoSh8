...
<View style={styles.Maincontainer}>
            ...
            <ImageBackground source={require("@/assets/recipecon.png")} style={{width: "100%", height: "100%"}} resizeMode="stretch">
                <ScrollView contentContainerStyle={styles.contentContainer} horizontal={false} style={styles.innercontainer}>
                  <ChatContainer news={false} nav={navigation} name={"Alyssa Yap"} last={"Last seen 1h ago."}></ChatContainer>
                  <ChatContainer news={true} nav={navigation} name={"Rachel Gunn"} last={"Last seen 2d ago."}></ChatContainer>
                  <ChatContainer news={true} nav={navigation} name={"Jack Anderson"} last={"Last seen 8w ago."}></ChatContainer>
                  <ChatContainer news={true} nav={navigation} name={"Janelle Lee"} last={"Last seen 1yrs ago."}></ChatContainer>
                  <ChatContainer news={true} nav={navigation} name={"Juan"} last={"Last seen 5yrs ago."}></ChatContainer>
                </ScrollView>
            </ImageBackground>
