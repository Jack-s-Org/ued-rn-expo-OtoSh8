...
function LandingThree({navigation}){
    ...
    return(
        ...
        <View style={{display:"flex",flexDirection:"column", rowGap:12, paddingBottom:24}}>
            ...
            <Text style={{fontFamily:"K2DBOLD",lineHeight: 40, fontSize:40, color:"white",marginBottom: 8}}>Chat, Share and {"\n"}Discuss</Text>
            <Text style={{fontFamily:"K2D", fontSize:15, fontWeight:500, color:"white"}}>Share your experiences and grow with {"\n"} other homecooks.</Text>
            </View>
            ...
            <LandingButton nav={navigation} page={1}></LandingButton>
        </View>
        </SafeAreaView>
        </GestureHandlerRootView>
        </View>
