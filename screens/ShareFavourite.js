...
<View style={styles.Maincontainer}>
            ...
            <ImageBackground source={require("@/assets/recipecon.png")} style={{width: "100%", height: "100%"}} resizeMode="stretch">
                <ScrollView contentContainerStyle={styles.contentContainer} horizontal={false} style={styles.innercontainer}>
                  ...
                  <Recipe nav={navigation}  fav={true} variant={2} name="Basted Steak" time="30 mins" cal="230 kcal" image={3}></Recipe>
                  <Recipe nav={navigation}  fav={true} variant={0} name="Egg Fried Rice" time="30 mins" cal="230 kcal" image={2}></Recipe>
                  
                  </View>
                  <View style={{flexDirection:"row", justifyContent:"space-between",width:"100%", paddingHorizontal:6}}>
                  <Recipe nav={navigation} fav={true}  variant={1} name="Chocolate Cake" time="30 mins" cal="230 kcal" image={0}></Recipe>
                  <Recipe nav={navigation} fav={true} variant={2} name="Stir Fry Noodles" time="30 mins" cal="230 kcal" image={1}></Recipe>
                  </View>
